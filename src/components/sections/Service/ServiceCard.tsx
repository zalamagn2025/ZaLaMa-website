...
export function ServiceCard({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-300"
    >
