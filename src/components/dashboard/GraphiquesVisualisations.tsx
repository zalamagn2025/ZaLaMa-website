          ...
          <div className="h-64 w-full mt-4">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <XAxis dataKey="name" stroke="var(--zalama-gray)" fontSize={12} />
                <YAxis stroke="var(--zalama-gray)" fontSize={12} />
                <Tooltip 
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar 
                  ...
                  label={{ position: 'top', formatter: (value: number) => `${value}%`, fontSize: 12, fill: 'var(--zalama-gray)' }}
                />
              </BarChart>
            </ResponsiveContainer>
          </div>
