// Script de test professionnel pour les emails de partenariat
require('dotenv').config();

console.log('🚀 TEST PROFESSIONNEL - EMAILS DE PARTENARIAT (5 EMAILS)');
console.log('========================================================');
...
async function testEmailService() {
  try {
    ...
    console.log('\n📤 Envoi des 5 emails de partenariat...');
...
function displayResults(result) {
  ...
  // Email Admin
  console.log('\n📧 Email Admin:');
  console.log(`  Statut: ${result.adminEmail.success ? '✅ Succès' : '❌ Échec'}`);
  ...
  // Email Contact
  console.log('\n📧 Email Contact (contact@zalamagn.com):');
  ...
  console.log(`  Emails réussis: ${successCount}/5`);
}
